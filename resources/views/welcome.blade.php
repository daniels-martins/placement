   ...
   <div
      ...
      <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
         <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            ...
            <img src="/static_assets/fuoye-bg.png" alt="">
         </div>

         <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1">
               <div class="flex items-center">
                  <h1 class="text-lg mx-auto"> Student Placement System</h1>
               </div>
               @auth
               <div class="flex  justify-between items-center">
                  <p class="text-lg block mx-auto"> <a href=""><small> Go to the Dashboard link at the top</small></a></p>
               </div>  
                  @else
                  <div class="flex  justify-between items-center">
                     <p class="text-lg block mx-auto"> <a href="/login">Login</a></p>
                     <p class="text-lg block mx-auto"> <a href="/register">Signup</a></p>
                  </div>      
               @endauth
